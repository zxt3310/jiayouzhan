...
var z=gz$gwx_9()
var xIB=_n('view')
_rz(z,xIB,'style',0,e,s,gg)
var oJB=_mz(z,'mpvue-picker',['bind:__l',1,'bind:onConfirm',1,'class',2,'data-event-opts',3,'data-ref',4,'deepLength',5,'mode',6,'pickerValueArray',7,'vueId',8],[],e,s,gg)
_(xIB,oJB)
var fKB=_mz(z,'mpvue-picker',['bind:__l',10,'bind:onConfirm',1,'class',2,'data-event-opts',3,'data-ref',4,'deepLength',5,'mode',6,'pickerValueArray',7,'vueId',8],[],e,s,gg)
_(xIB,fKB)
_(r,xIB)
return r
}
...
var a6B=_mz(z,'view',['bindtap',4,'class',1,'data-event-opts',2,'style',3],[],c3B,o2B,gg)
var t7B=_mz(z,'uni-icon',['bind:__l',8,'color',1,'size',2,'type',3,'vueId',4],[],c3B,o2B,gg)
_(a6B,t7B)
var e8B=_mz(z,'uni-icon',['bind:__l',13,'color',1,'size',2,'type',3,'vueId',4],[],c3B,o2B,gg)
_(a6B,e8B)
_(o4B,a6B)
return o4B
}
cZB.wxXCkey=4
_2z(z,2,h1B,e,s,gg,cZB,'star','index','index')
return r
}
